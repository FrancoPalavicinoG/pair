...
- [ ] Authorization Server OAuth 2.1 con DCR + PKCE, a mano (sin librería — ver `docs/specs/mcp-oauth-server.md`; los helpers de auth del SDK de MCP están deprecados/congelados y son Express, no Hono).
